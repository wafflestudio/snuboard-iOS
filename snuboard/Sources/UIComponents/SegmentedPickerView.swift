...
struct SegmentedPicker: View {
    ...
    private static let TextColor: Color = Const.Colors.Gray1.color
    private static let SelectedTextColor: Color = Const.Colors.Blue2.color
    ...
    private var activeSegmentView: AnyView {
        ...
        return
            Rectangle()
                ...
                .padding([.bottom], 2)
                .background(Const.Colors.Blue2.color)
